...
const OurTestimonial = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-5 my-5">
      <h1 className="text-2xl font-semibold underline underline-offset-2">Testimonial</h1>
      <div className="flex md:flex-row flex-col w-full justify-center items-center gap-5">
        {dummyData.map((eachData, index) => {
          return (
            <Card
              key={index}
              className="w-full flex flex-col gap-1 justify-center items-center p-3"
            >
              <Image
                src={eachData.image}
                alt="User"
              ...
              />
              <h1 className="text-[0.8rem] text-center">{eachData.message}</h1>
